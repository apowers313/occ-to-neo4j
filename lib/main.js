...
class Importer {
    ...
    loadData(dataPath, dbPath) {
        ...
        return Promise.resolve()
            ...
            .then(() => {
                this.createCsv("brWriter", "br.csv", ["iri", "label", "record_type", "title", "subtitle", "year", "number"]);
    ...
    writeBrRecord(record) {
        ...
        // console.log ("Title:", writeRecord[3]);
    ...
    writeArRecord(record) {
        ...
        var writeRecord = [
            // ["iri", "record_type", "label", "role_of", "role_type", "next"]
            record.iri,
            record.a,
            record.label,
            record.role_of,
    ...
    writeBeRecord(record) {
        ...
        var writeRecord = [
            // ["iri", "record_type", "label", "content", "crossref"]
            record.iri,
            record.a,
            record.label,
    ...
    writeReRecord(record) {
        ...
        var writeRecord = [
            // ["iri", "record_type", "label", "fpage", "lpage"]
            record.iri,
            record.a,
            record.label,
            record.fpage,
    ...
    writeRaRecord(record) {
        ...
        var writeRecord = [
            // ["iri", "record_type", "label", "gname", "fname", "name", "identifier"]
            record.iri,
            record.a,
            record.label,
            record.gname,
...
function getBrTitle(record) {
    ...
    if (title === undefined) {
        ...
        title = sanitizeHtml(title, htmlConfig);
    }
